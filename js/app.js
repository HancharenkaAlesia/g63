(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".logos__slider")) new core(".logos__slider", {
            ...
            if (document.querySelector(".rewiew-portfolio__slider")) new core(".rewiew-portfolio__slider", {
                ...
                navigation: {
                    prevEl: ".rewiew-portfolio__prev",
                    nextEl: ".rewiew-portfolio__next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        function more(trigger, moreObj, openBodyClass) {
            if (trigger) trigger.addEventListener("click", (() => {
                moreObj.classList.toggle(openBodyClass);
                showMoreIcon.classList.toggle("more__icon_opened");
            }));
        }
        more(document.querySelector(".about-us__more"), document.querySelector(".about-us__body"), "about-us__body_opened");
        more(document.querySelector(".about-bb__more"), document.querySelector(".about-bb__wrapper"), "about-bb__wrapper_opened");
        more(document.querySelector(".about-smm__more"), document.querySelector(".about-smm__wrapper"), "about-smm__wrapper_opened");
        new window.JustValidate(".about-user__form", {
            rules: {
                text: {
                    required: true,
                    minLength: 2,
            ...
            messages: {
                name: {
                    required: "*Use your real name",
                    minLength: "*Use your real name",
                    maxLength: "*Use your real name"
                },
                text: {
                    required: "*Use your real last name",
                    minLength: "*Use your real last name",
                    maxLength: "*Use your real last name"
                },
                email: {
                    required: "*Use your real email",
                    email: "*Use your real email",
                    remote: "*Use your real email"
                }
            },
            submitHandler: function(thisForm) {
                var checked = document.querySelectorAll("input[type=checkbox]:checked");
                if (0 == checked.length) document.querySelector(".form__error").style.display = "block"; else {
                    ...
                    xhr.onreadystatechange = function() {
                        if (4 === xhr.readyState) if (200 === xhr.status) {
                            console.log("Success");
                            modules_flsModules.popup.open("#popup__enquiry");
                        } else modules_flsModules.popup.open("#popup__error");
                    };
        ...
        new window.JustValidate(".subscribe__form", {
            ...
            submitHandler: function(thisForm) {
                ...
                xhr.onreadystatechange = function() {
                    if (4 === xhr.readyState) if (200 === xhr.status) {
                        console.log("Success");
                        modules_flsModules.popup.open("#popup__thanks");
                    } else modules_flsModules.popup.open("#popup__error");
                };
                xhr.open("POST", "mail.php", true);
                xhr.send(formData);
        ...
        let formDataEmail;
        let formDataAll;
        const formTitle1 = document.querySelector("#popup-title-1"), formTitle2 = document.querySelector("#popup-title-2"), formTitle3 = document.querySelector("#popup-title-3"), formTitle4 = document.querySelector("#popup-title-4"), formBody1 = document.querySelector("#popup-form-1"), formBody2 = document.querySelector("#popup-form-2"), formBody3 = document.querySelector("#popup-form-3"), formBody4 = document.querySelector("#popup-form-4");
        document.addEventListener("beforePopupOpen", (function(e) {
            menuClose();
        }));
        new window.JustValidate("#popup-form-1", {
            rules: {},
            messages: {},
            submitHandler: function(thisForm) {
                var checked = document.querySelectorAll("#popup-form-1 input[type=checkbox]:checked");
                if (0 == checked.length) document.querySelector("#popup-form-1 .form__error").style.display = "block"; else {
                    document.querySelector("#popup-form-1 .form__error").style.display = "none";
                    formDataService = new FormData(thisForm);
                    formVisible(formTitle1, formBody1, formTitle2, formBody2);
                    thisForm.reset();
                }
            }
        });
        new window.JustValidate("#popup-form-2", {
            rules: {
                name: {
                    required: true,
                    minLength: 2,
            ...
            colorWrong: "white",
            submitHandler: function(thisForm) {
                formDataName = new FormData(thisForm);
                formVisible(formTitle2, formBody2, formTitle3, formBody3);
                thisForm.reset();
            }
        });
        new window.JustValidate("#popup-form-3", {
            rules: {},
            messages: {
                email: {
                    required: "*Use your real email",
            ...
            colorWrong: "white",
            submitHandler: function(thisForm) {
                formDataEmail = new FormData(thisForm);
                formVisible(formTitle3, formBody3, formTitle4, formBody4);
                thisForm.reset();
            }
        });
        new window.JustValidate("#popup-form-4", {
            rules: {},
            messages: {},
            colorWrong: "white",
            submitHandler: function(thisForm) {
                formDataAll = new FormData(thisForm);
                for (var pair of formDataService.entries()) formDataAll.append(pair[0], pair[1]);
                for (var pair of formDataName.entries()) formDataAll.append(pair[0], pair[1]);
                for (var pair of formDataEmail.entries()) formDataAll.append(pair[0], pair[1]);
                let xhr = new XMLHttpRequest;
                xhr.onreadystatechange = function() {
                    if (4 === xhr.readyState) if (200 === xhr.status) {
                        console.log("Success");
                        ...
                        formVisible(formTitle4, formBody4, formTitle1, formBody1);
                    } else {
                        modules_flsModules.popup.open("#popup__error");
                        thisForm.reset();
                        formVisible(formTitle4, formBody4, formTitle1, formBody1);
                        document.querySelector("html").classList.remove("lock");
                    }
                ...
                xhr.open("POST", "mail.php", true);
                xhr.send(formDataAll);
                thisForm.reset();
            }
        });
        function formVisible(formTitleClose, formBodyClose, formTitleOpen, formBodyOpen) {
            formTitleClose.style.display = "none";
            formBodyClose.style.display = "none";
            formTitleOpen.style.display = "block";
            formBodyOpen.style.display = "block";
        }
        window.addEventListener("load", (function() {
            if (document.querySelector(".rewiew-portfolio")) {
                document.querySelector(".rewiew-portfolio").style.padding = "0";
                document.querySelector(".rewiew-portfolio__wrapper").style.height = "auto";
                document.querySelector(".rewiew-portfolio__slider").style.display = "block";
            }
        }));
        document.addEventListener("beforePopupClose", (function(e) {
            const currentPopup = e.detail.popup;
            if ("#popup__video" == currentPopup.hash) document.querySelector(".popup__video").pause();
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
